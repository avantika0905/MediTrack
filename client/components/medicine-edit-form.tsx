  ...
  useEffect(() => {
    const fetchMedicine = async () => {
      ...
      try {
        ...
        toast({
          title: "Failed to fetch medicine",
          description: "There was an error fetching the medicine details. Please try again.",
          variant: "destructive",
        })
        router.push("/profile/medicine-management")
      }
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <Button type="button" variant="outline" onClick={() => router.push("/profile/medicine-management")}>
                Cancel
              </Button>
            </div>
          </form>
